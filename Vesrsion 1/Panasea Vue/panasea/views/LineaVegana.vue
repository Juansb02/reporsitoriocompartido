    ...
    created () {
        this.lineasVeganas = [
            ...
            },
            {
                ...
                descripcion: 'Optimiza el rendimiento y retrasa la fatiga muscular con Vegan Energy Gel; perfecto para situaciones de máxima demanda energética. Vegan Energy Gel es recomendable para todo tipo de deportistas, en especial aquellos que siguen una alimentación vegana, y que busquen un aporte energético (inmediato y sostenido) de origen natural durante la actividad física..</p> <p>Formulado a base de: Arroz ecológico, Sirope de agave y concentrado de uva, Zumo concentrado de limón y naranja, Acerola'
            }
